...
export default function AdminSidebar() {
  ...
  return (
    <aside className={cn(
      "flex flex-col h-full bg-gray-900 text-gray-100 transition-all duration-300 relative",
      collapsed ? "w-16" : "w-64"
    )}>
      {/* Logo */}
      <div className={cn(
      ...
      <button
        ...
        className="absolute -right-3 top-20 w-6 h-6 rounded-full bg-gray-700 border
                   border-gray-600 text-gray-300 flex items-center justify-center
                   hover:bg-gray-600 transition-colors z-10 shadow-md"
      ...
      <div className="border-t border-gray-700/50 shrink-0">
        <Link href="/admin/profile"
          className={cn("flex items-center px-3 py-3 hover:bg-gray-700/40 transition-colors",
