...
export default function MapView({
  ...
  useEffect(() => {
    ...
    issues.forEach((issue) => {
      ...
      const color  = MAP_MARKER_COLORS[issue.status] ?? "#6b7280";
...
function buildPopupHTML(issue: Issue): string {
  ...
  return `
    <div style="font-family: Inter, sans-serif; min-width: 200px; max-width: 240px;">
      <p style="font-size: 12px; font-weight: 700; color: #111827; margin: 0 0 4px 0; line-height: 1.4;">
        ${issue.title}
      </p>
      ...
      <a href="/issues/${issue.id}"
         style="
           ...
           padding: 6px; border-radius: 8px; font-size: 11px;
