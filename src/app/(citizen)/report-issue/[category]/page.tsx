...
import { MapPin, Loader2, CheckCircle2, Navigation, ImageIcon, Mic } from "lucide-react";
...
export default function ReportIssueFormPage({
  ...
  const category = rawCategory as IssueCategory;
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      <div className={cn(
        ...
        <div>
          <p className={cn("text-sm font-bold", categoryMeta.color)}>{categoryMeta.label}</p>
        ...
        {currentStep === 1 && (
          <Card>
            ...
            <div className="space-y-5">
              ...
              {/* ── Audio Description (right below text description) ── */}
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <Mic size={15} className="text-gray-400" />
                  <span className="text-sm font-medium text-gray-700">Voice Description</span>
                  <span className="text-xs text-gray-400">(optional, up to 2 min)</span>
                </div>
                <AudioRecorder
                  onUploadComplete={(url) => setUploadedAudioUrl(url)}
                  disabled={submitting}
                />
              </div>
          ...
          <Card>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-xl p-4 space-y-3">
                ...
                <ReviewRow
                  label="Audio"
                  value={uploadedAudioUrl ? "Voice description attached" : "No voice note attached"}
                />
              </div>
